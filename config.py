...
class Config:
    def __init__(self):
        ...
        self.DURATION_LIMIT = int(getenv("DURATION_LIMIT", 0)) * 60  # 0 = unlimited
        ...
        self.SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/botarcade")
        ...
        # -- Upgrade pack settings --
        self.VOTE_SKIP_ENABLED: bool = getenv("VOTE_SKIP_ENABLED", "True").lower() == "true"
        self.VOTE_SKIP_RATIO = float(getenv("VOTE_SKIP_RATIO", 0.5))  # fraction of members needed
        self.VOTE_SKIP_MIN = int(getenv("VOTE_SKIP_MIN", 2))  # min votes required regardless of ratio
        self.LYRICS_ENABLED: bool = getenv("LYRICS_ENABLED", "True").lower() == "true"
        ...
        self.START_IMG = getenv("START_IMG", "https://i.ibb.co/ZpWw9LFY/Earbud-Bot.png")
